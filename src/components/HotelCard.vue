    ...
    <article class="card-container">
        <div class="card-body">
            ...
            <div class="card-body__text">
                <h2 class="card-body__title"><slot name="card-title"></slot></h2>
                <p><slot name="card-info"></slot></p>
              
                <span>Mas información<span class="header-toggle-arrow" @click="cardToggleBody">
                    <font-awesome-icon :icon="['fas', 'chevron-down']" size="sm" :class="[{rotateArrow:cardBodyShown}]"/>
                </span></span>
